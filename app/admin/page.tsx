...
<div className="w-full h-[300px] bg-zinc-800 flex items-center justify-center text-4xl font-bold">
Yukiyo Manga
</div>
...
<img src={manga.cover} className="rounded-lg" />
...
<Link key={manga.id} href="/reader">

<div className="cursor-pointer">

<img src={manga.cover} className="w-40 rounded"/>
